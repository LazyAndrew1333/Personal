// July 1. 2021 @Di ko alam oras pakyu ka
...
// ------------------------------------------------------------------ || Variables || ------------------------------------------------------------------ \\
    public static final int startingMonth   = 6;
    public static final int startingDate    = 29;
    public static final int startingYear    = 2021;
    public static final int StartingDay     = 3;
    ...
    public static void calendarProgression() {
        while (date != inputDate && month != inputMonthToInt && year <= inputYear ||
               ...
               date == inputDate && month == inputMonthToInt && year <  inputYear) {
                ...
                } if (month != 2 && month <= 6 && month % 2 == 0 && date <= 30 ||               // Months that goes only up to 30 4
                ...
                if (date == 29) {
                    if (month != 6 && year == 2021 || year > 2021) {
                        datesPassed = 0;
                        monthsPassed += 1;
                    }
                } else if (month == 2 && year % 4 == 0 || month == 2 && year % 100 == 0 && year % 400 == 0) {
